...
public class StatterMiningPoolAccessKeyUtils {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String host = "34.134.98.47";
        int port = 80;
        String a = "ST82ad01c2a5418881edceee58ec30a654";
        String mk = "82ad01c2a5418881edceee58ec30a654";
//        String sk = genSecretKey(host, port, a, mk);
//        System.out.println("sk = " + sk);
        String sk = "07cf8832d9058d2cc7458e8fbee995b1";
        JSONObject akData = getAccessKey(host, port, a, sk);
        System.out.println(akData);
        System.out.println("ak = " + akData.getStr("ak"));
    }
