...
public class MinerVersionController {
    ...
    @GetMapping("/")
    public String get() {
        // Pointing to script file:`.../nginx/downloads/statter.update.v1.0.1.sh.template`，
        // After each time the script is released, the version and script are updated,
        // and update the return value of this interface,
        // the final version increases, avoid the update of the same version without triggering the update
